...
const NotebookIllustration = () => (
  <View className="items-center justify-center">
    <Svg width={200} height={240} viewBox="0 0 200 240">
      <Rect x="20" y="40" width="140" height="180" rx="8" fill="white" stroke="#e5e7eb" strokeWidth="2" />
      ...
      <Path d="M35 70 L145 70 M35 90 L145 90 M35 110 L145 110 M35 130 L145 130" stroke="#e5e7eb" strokeWidth="1" />
      <Rect x="120" y="60" width="60" height="8" rx="4" fill="#0891b2" transform="rotate(45 150 64)" />
      ...
      <LinearGradient colors={["#7e1b8c", "#ff6f91"]} style={{ flex: 1 }} start={{ x: 0, y: 0 }} end={{ x: 0, y: 1 }}>
        <View className="flex-1 justify-center items-center px-8">
          <View className="mb-16">
            <Text className="text-white text-4xl font-bold text-center tracking-wide">Wordsy</Text>
          </View>
          ...
          <View className="mb-16 bg-wordsy-cyan rounded-2xl px-6 py-4 mx-4">
            <Text className="text-white text-xl font-semibold text-center">All your ideas{"\n"}in one place</Text>
          </View>

          <TouchableOpacity
            onPress={handleGetStarted}
            className="bg-gray-800 rounded-full px-12 py-4 shadow-lg"
            activeOpacity={0.8}
          >
